...
window.CENTRAL_CONFIG = {
  ...
  seedShops: {
    "tg-solingen": {
      ...
      productPrint:{tshirt:{front:{xPct:68,yPct:16,widthPct:28},back:{xPct:50,yPct:36,widthPct:50}},polo:{front:{xPct:68,yPct:22,widthPct:28},back:{xPct:50,yPct:36,widthPct:50}},hoodie:{front:{xPct:68,yPct:22,widthPct:36},back:{xPct:50,yPct:34,widthPct:54}}},
    ...
    "hansa": {
      ...
      shirtPrice:15,currency:"EUR",orderEmail:"shirtzentrale@gmail.com",orderSubject:"Neue Hansa Berufskolleg T-Shirt Bestellung",customerExtraFieldLabel:"Adresse",customerExtraFieldName:"Adresse",orderPrefix:"HAN",shopType:"motifs",active:true,
