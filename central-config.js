...
window.CENTRAL_CONFIG = {
  ...
  seedShops: {
    ...
    "tus-hemmerde": {
      ...
      initialsConfig:{label:"Initialen (optional)",placeholder:"z. B. TS",maxLength:3,stageXPct:29,stageYPct:90,fontSize:24,fontFamily:"Arial"},tusInitialsVersion:5,tusJc001Version:4,tusProductMotifVersion:1,
      ...
      motifs:[{id:"vereinslogo",name:"Vereinslogo",file:"motiv-1.png"},{id:"tus-3d-patch",name:"TuS 3D-Patch",file:"/tus-3d-patch.png?v=30.3.2",preserveColors:true}]
    },
    "_simple": {
