...
window.CENTRAL_CONFIG = {
  ...
  seedShops: {
    "tg-solingen": {
      ...
      features:{layout:"simple",motifMode:"single",allowCustomerUpload:false,allowText:false,allowMoveMotif:false,allowResizeMotif:false,allowRotateMotif:false,allowBackDesign:true,allowMotifColor:true,showShirtColorPicker:false,showMotifPicker:false,showMotifColorPicker:false,autoSelectSingleMotif:true,maxUploadMB:8,previewMode:"dual"},
